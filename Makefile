...
MY_SOURCES = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c \
ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c ft_itoa.c \
ft_memchr.c ft_memcpy.c ft_memmove.c ft_putchar_fd.c \
ft_putendl.fd.c ft_putnbr.fd.c ft_putstr_fd.c ft_strchr.c ft_striteri.c \
